-- Criação da tabela CFOP para Supabase (PostgreSQL)
...
ALTER TABLE cfop ADD PRIMARY KEY (id_cfop);

-- Adiciona índice para facilitar busca por código
CREATE INDEX idx_cfop_codigo ON cfop(codigo_cfop);

-- Inserção de todos os registros CFOP
