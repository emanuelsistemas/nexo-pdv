...
def execute_sql_file(sql_file_path):
    ...
    try:
        ...
        print("✅ SQL executado com sucesso! A função dinâmica de deleção de empresas foi instalada.")
...
if __name__ == "__main__":
    ...
    sql_file_path = os.path.join(current_dir, "dynamic_delete_company_function.sql")
    ...
    print("\nFunção RPC dinâmica instalada! Agora o sistema detectará automaticamente novas tabelas.")
