...
def get_database_url():
    ...
    # Solicita a URL manualmente se ainda não encontrou
    if not db_url:
        print("⚠️ DATABASE_URL não encontrada! Por favor, insira a URL de conexão do PostgreSQL:")
        db_url = input("> ")
...
def execute_sql_file(sql_file_path):
    ...
    try:
        ...
        print("✅ SQL executado com sucesso! A função de deleção de empresas foi atualizada.")
...
if __name__ == "__main__":
    ...
    sql_file_path = os.path.join(current_dir, "update_delete_company_function.sql")
