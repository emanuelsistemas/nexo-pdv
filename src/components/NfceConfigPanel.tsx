...
import { FiscalConfig } from '../utils/fiscalUtils';

interface NfceConfigProps {
  config: FiscalConfig;
  onChange: (config: any) => void;
  onSave: () => void;
}

export const NfceConfigPanel: React.FC<NfceConfigProps> = ({ config, onChange, onSave }) => {
  ...
  return (
    <div className="p-6 space-y-6">
      <h3 className="text-xl font-bold text-white mb-4">Configurações NFC-e (Modelo 65)</h3>
      ...
      <div className="bg-slate-800 p-4 rounded-lg">
        ...
        <p className="text-slate-400 mb-4">O certificado digital é necessário para emissão de NFC-e. Certifique-se de ter um certificado A1 válido.</p>
        ...
        <div className="flex flex-col space-y-4">
          <div>
            ...
            <div className="flex">
              <input
                ...
                value={config.nfce.certificadoArquivo}
                onChange={(e) => handleNfceChange('certificadoArquivo', e.target.value)}
                readOnly
              />
              <button
                type="button"
          ...
          <div>
            ...
            <input
              ...
              value={config.nfce.certificadoSenha}
              onChange={(e) => handleNfceChange('certificadoSenha', e.target.value)}
            />
          </div>
        </div>
      </div>
