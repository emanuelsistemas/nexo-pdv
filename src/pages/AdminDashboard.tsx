...
import { Database, Users, LogOut, BarChart2, Box, Search, ChevronLeft, ChevronRight, Ban, Trash2, X } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#1C1C1C] flex">
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              title={company.status === 'active' ? 'Bloquear' : 'Desbloquear'}
                            >
                              <Ban size={18} />
                            </button>
                            <button
      ...
      {showBlockConfirm && companyToToggle && (
        <>
            ...
            <div className="bg-[#2A2A2A] rounded-lg shadow-lg border border-gray-800 p-6 w-full max-w-[400px]">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">
                  Confirmar {companyToToggle.status === 'active' ? 'Bloqueio' : 'Desbloqueio'}
                </h3>
                <button
              ...
              <p className="text-gray-300 mb-6">
                Tem certeza que deseja {companyToToggle.status === 'active' ? 'bloquear' : 'desbloquear'} a empresa "{companyToToggle.trade_name}"?
              </p>
              <div className="flex justify-end gap-3">
                ...
                >
                  {companyToToggle.status === 'active' ? 'Bloquear' : 'Desbloquear'}
                </button>
              </div>
            </div>
          </div>
