        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <button
              ...
              className="text-slate-300 hover:text-white hidden md:flex items-center gap-1"
            ...
            <div className="relative">
              <button
                ...
                className="h-8 w-8 rounded-full bg-blue-500 text-white flex items-center justify-center hover:bg-blue-400 transition-colors relative">
                <User size={16} />
              </button>
